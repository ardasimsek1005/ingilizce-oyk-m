...
for idx, story in enumerate(STORIES_TO_GENERATE):
    ...
    while chapter <= 5:
        ...
        chapter += 1
        time.sleep(5) # 5 seconds delay between parts to avoid rate limits
