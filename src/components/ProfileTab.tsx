            ...
            {userEmail ? (
              <div className="mt-5 w-full max-w-sm mx-auto space-y-3 pt-4 border-t border-dashed border-gray-400/20">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { id: 'email', name: 'E-posta', color: '#4ECDC4', icon: (
                      <svg className="w-4 h-4 fill-none stroke-current text-white shrink-0" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="mt-5 w-full max-w-sm mx-auto space-y-2.5 pt-4 border-t border-dashed border-gray-400/20">
                ...
                <button
                  type="button"
                  onClick={() => {
                    setMockLoginProvider('apple');
                    setShowMockLogin(true);
                  }}
                  className="w-full py-3.5 px-4 bg-[#1E1E22] hover:bg-[#2A2A30] text-white rounded-2xl text-xs font-bold transition-all flex items-center justify-between cursor-pointer shadow-2xs font-headline-lg relative overflow-hidden group border border-white/5"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-lg bg-white/10 flex items-center justify-center shrink-0">
                      <svg className="w-3.5 h-3.5 fill-current text-white" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className="w-full py-3.5 px-4 bg-[#4ECDC4] hover:bg-[#3cacb0] text-[#1E1E22] rounded-2xl text-xs font-bold transition-all flex items-center justify-between cursor-pointer shadow-2xs font-headline-lg relative overflow-hidden group"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-lg bg-black/10 flex items-center justify-center shrink-0">
                      <svg className="w-3.5 h-3.5 fill-none stroke-current text-[#1E1E22]" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                        <rect x="2" y="4" width="20" height="16" rx="2"/>
                        <path d="M22 6l-10 7L2 6"/>
                      </svg>
                    </div>
                  ...
                  <ChevronRight className="w-4 h-4 text-[#1E1E22]/70 group-hover:translate-x-0.5 transition-transform" />
                </button>
              </div>
            )}
          </>
